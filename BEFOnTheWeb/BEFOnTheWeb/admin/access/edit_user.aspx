...
<h3>Roles:</h3>
<asp:CheckBoxList ID="UserRoles" runat="server" CssClass="CheckboxList" RepeatDirection="Horizontal" OnSelectedIndexChanged="UserRoles_SelectedIndexChanged" TextAlign="Left" />
<h3>Main Info:</h3>
