...
namespace BEFOnTheWeb.admin
{
    public partial class PasswordReset : System.Web.UI.Page
    {
        ...
        protected void bntSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                MembershipProvider mp =  Membership.Providers["AspNetSqlMembershipProviderAdministrativeReset"];
                lblMsg.Visible = false;
                string uname = txbUName.Text;
                string uPW = txbuPW.Text;
 //               MembershipUser u = mp.FindUsersByName(uname)[uname.ToString()];
                MembershipUser u = mp.GetUser(uname.ToString(), true);
