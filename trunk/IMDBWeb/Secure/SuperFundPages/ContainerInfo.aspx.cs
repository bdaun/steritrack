    ...
    public partial class ContainerInfo : System.Web.UI.Page
    {
        protected void Page_Load(Object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                gvGridLoc.EmptyDataText = "Please select a Grid Location and/or a ContainerID";
                btnPrint.Visible = false;
                lblInstructions.Text = "* Select a Grid Area location to begin";
            }
            else
            {
                gvGridLoc.EmptyDataText = "There are no Values for that Grid or ContainerID";
            }
        ...
        protected void ddGridLoc_SelectedIndexChanged(Object sender, EventArgs e)
        {
            if (ddGridLoc.SelectedIndex == 0 && txbCntrID.Text== "")
            {
                ...
                btnGo.Visible = false;
                btnPrint.Visible = false;
                lblInstructions.Text = "* Select a Grid Area location to begin.  Select 'ALL' to see all containers in all locations";
            }
            else
            {
