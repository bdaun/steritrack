<%@ Page Title="" Language="C#" MasterPageFile="~/Mobile.Master" AutoEventWireup="true" CodeBehind="mAggregateContainer.aspx.cs" Inherits="TeleiosDemo.Secure.mobilepages.AggregateContainer" %>
...
<%--<asp:RequiredFieldValidator ControlToValidate="txbnewCntr" runat="server" 
    ErrorMessage="You must enter a value in this field" ForeColor="Red" Font-Bold="true" SetFocusOnError="True" /><br />
<asp:RegularExpressionValidator ID="valCheck" ControlToValidate="txbNewCntr" runat="server" ForeColor="Red" Font-Bold="true" 
    ErrorMessage="This is not a Valid Container ID" ValidationExpression="^[IO][UN][T]?[-](\d{6})*$" SetFocusOnError="True" />--%>
</asp:Content>
