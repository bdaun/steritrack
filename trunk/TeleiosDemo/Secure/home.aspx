<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="TeleiosDemo.home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="border:none;border-bottom:solid #4F81BD 1.0pt;padding:0in 0in 4.0pt 0in">
        <p class="MsoTitleCxSpFirst">
            &nbsp;</p>
        <p class="MsoTitleCxSpFirst">
            <span class="style2" style=" font-size:32pt; color: blue"></span>
            <span class="style1" style=" font-size:larger; color: blue"><em>TeleiosDemo</em></span></p>
