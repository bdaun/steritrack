...
Inherits="TeleiosDemo.Secure.SuperFundPages.ContainerInfo" EnableEventValidation="false" %>
    ...
    <tr>
        <td>
            <asp:DropDownList ID="ddGridLoc" runat="server" DataSourceID="sds_SFGridLoc" 
                ...
                <asp:ListItem Text="Select a Container Location" Value="" />
...
<table width="85%">
<tr><td>
    <asp:Label ID="lblCntrCnt" runat="server" Text="Container Count in Location: " />
        ...
        <asp:Panel ID="Panel1" runat="server" >
            <asp:FormView ID="fvLabel" runat="server" BorderColor="Black" BorderStyle="Double" DataSourceID="sdsCntrDetails" Width="4.5in"
             OnDataBound="fvLabel_OnDataBound" >
                <ItemTemplate>
                    <div align="center">
                    <asp:Label ID="lblPRP" runat="server" Font-Bold="true" Font-Size="48px" Text='<%# String.Format("{0}{1}",Eval("CompanyPRP"),"-") %>' />
                    <asp:Label ID="lblGridLoc" runat="server" Font-Bold="true" Font-Size="48px" Text='<%# String.Format("{0}{1}",Eval("GridLocation"),"-") %>' />
                    <asp:Label ID="lblcntrid" runat="server" Font-Bold="true" Font-Size="48px" Text='<%# Eval("ContainerID") %>' /><br />
