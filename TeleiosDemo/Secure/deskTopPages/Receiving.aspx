<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Receiving.aspx.cs" Inherits="TeleiosDemo.Secure.SPAKpages.Receiving" EnableEventValidation="false"%>
...
<tr runat="server" id="trClient">
    ...
    <td width="300px">
        <asp:TextBox ID="txbClientName" runat="server" OnTextChanged="txbClientName_OnTextChanged" AutoPostBack="true" Width="250px"></asp:TextBox>
            <ajaxToolkit:AutoCompleteExtender
            ...
            <ContentTemplate>
                <asp:GridView
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="vendorname1" HeaderText="TSDF" SortExpression="vendorname1" />
                        <asp:BoundField DataField="vendorname" HeaderText="Carrier" SortExpression="vendorname" />
                        <asp:BoundField DataField="ShipDate" DataFormatString="{0:MM/d/yyyy}" HeaderText="ShipDate" SortExpression="ShipDate" />
                        <asp:BoundField DataField="ReceivedBy" HeaderText="Received By" SortExpression="ReceivedBy" />
                        <asp:BoundField DataField="ReceiveDate" HeaderText="Receive Date" SortExpression="ReceiveDate" DataFormatString="{0:MM/d/yyyy}" />
                        <asp:BoundField DataField="ReceiveDock" HeaderText="Receive Dock" SortExpression="ReceiveDock" />
                    </Columns>
                    <SelectedRowStyle BackColor="#FFFF99" />
                </asp:GridView>
                    <asp:SqlDataSource
                ...
                <tr>
                    <td width="400px">
                        <asp:Label ID="Label5" runat="server" Font-Bold="True" 
                            Text="Listing Inbound Document Numbers" visible="false"></asp:Label>
                    </td>
                    <td>
                    ...
                    <ItemTemplate>
                        ...
                        <asp:GridView
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="InboundDocNo" HeaderText="Doc No" SortExpression="InboundDocNo" Visible="false"/>
                                <asp:BoundField DataField="InboundContainerID" HeaderText="Cntr ID" SortExpression="InboundContainerID" ItemStyle-Wrap="false" />
                                <asp:BoundField DataField="BCName" HeaderText="Brand Code" SortExpression="BCName" ItemStyle-Wrap="false" />
                                <asp:BoundField DataField="ManifestLineNumber" HeaderText="ManLine" SortExpression="ManifestLineNumber" />
                                <asp:BoundField DataField="name" HeaderText="Profile" SortExpression="name" ItemStyle-Wrap="false" />
                                ...
                                <asp:BoundField DataField="InventoryLocation" HeaderText="Location" SortExpression="InventoryLocation" />
                            ...
                            <asp:TemplateField>
                                <InsertItemTemplate>
                                    <table class="ui-accordion">
                                        <tr>
                                            <td>Order Number</td>
                                            <td><asp:TextBox ID="txbOrderNumber" Width="250px" runat="server" Text='<%# bind("OrderNumber") %>' /></td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td>Work Order</td>
                                            <td><asp:TextBox ID="txbWorkOrder" Width="250px" runat="server" Text='<%# bind("WorkOrder") %>' /></td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td>Client</td>
                                            <td><asp:TextBox ID="txbClientName2" Width="250px" runat="server" 
                                            OnTextChanged="txbClientName2_OnTextChanged" AutoPostBack="true" />
                                                <ajaxToolkit:AutoCompleteExtender
                                                    ID="txbClientName_AutoCompleteExtender" 
                                                    runat="server"
                                                    Enabled="True"
                                            ...
                                            <td>
                                                <asp:Label ID="lblClientID" runat="server" Text='<%# bind("ClientName") %>' Visible="false"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>TSDF</td>
                                            <td>
                                                <asp:TextBox ID="txbTSDFName" Width="250px" runat="server" 
                                                    OnTextChanged="txbTSDFName_OnTextChanged" AutoPostBack="true" />
                                                <ajaxToolkit:AutoCompleteExtender
                                            ...
                                            <td>
                                                <asp:Label ID="lblTSDFid" runat="server" Text='<%# bind("TSDF") %>' Visible="false" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Ship Date</td>
                                            ...
                                            <td>Carrier</td>
                                            <td>
                                                <asp:TextBox ID="txbCarrierName" Width="250px" runat="server"
                                                OnTextChanged="txbCarrierName_OnTextChanged" AutoPostBack="true"></asp:TextBox>
                                                <ajaxToolkit:AutoCompleteExtender
                                            ...
                                            <td>
                                                <asp:Label ID="lblCarrierID" runat="server" Text='<%# bind("carrier") %>' Visible="false"></asp:Label> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Trailer Number</td>
                                            <td>
                                                <asp:TextBox ID="txbTrailerNum" Width="250px" runat="server"
                                        ...
                                        <tr>
                                            <td>Receive Date</td>
                                            <td>
                                                <asp:TextBox ID="txbRcvDate" Width="250px" runat="server" Text='<%# bind("ReceiveDate") %>' />
                                                    <ajaxToolKit:CalendarExtender
