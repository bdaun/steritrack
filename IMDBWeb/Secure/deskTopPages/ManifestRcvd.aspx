<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManifestRcvd.aspx.cs" Inherits="IMDBWeb.Secure.deskTopPages.ManifestRcvd" %>
    ...
    <tr>
        <td colspan="2">
            ...
            <asp:RegularExpressionValidator ID="revTxbTruckID" runat="server" ControlToValidate="txbTruckID" SetFocusOnError="true"
                ...
                <td style="vertical-align:top; text-align:right"><asp:Button ID="btnClose" runat="server" Text="Close" /></td>
        <td>&nbsp;</td>
    </tr>
