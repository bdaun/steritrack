...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <asp:UpdatePanel ID="udp_gvSearchResults" runat="server" UpdateMode="always">
                    <ContentTemplate>
                        ...
                        <asp:GridView
                            ...
                            OnSelectedIndexChanged="gvRcvDetail_SelectedIndexChanged">
                            <Columns>
                                <asp:templatefield>
                                <ItemTemplate>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        ...
                        OnItemCommand="DetailsView1_ItemCommand" Visible="False">
                            <EmptyDataTemplate>
                                No Data
                            </EmptyDataTemplate>
                    <Fields>
                            ...
                            <InsertItemTemplate>
                                <table class="ui-accordion">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <asp:Label ID="lblTSDFid" runat="server" Text='<%# bind("TSDF") %>' Visible="false"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
        ...
        <tr>
            <td>
                ...
                <asp:DetailsView ID="DetailsView2" runat="server" AutoGenerateRows="False" 
                            DataKeyNames="ID" DataSourceID="SqlDataSource3" Height="50px" Width="400px"
                            OnItemCommand="DetailsView2_ItemCommand" Visible="False" 
                            DefaultMode="Insert">
                            <EmptyDataTemplate>
                                No data in detail
                            </EmptyDataTemplate>
                                ...
                                <table class="ui-accordion">
                                    <tr>
                                        <td>
                                            Inbound Doc No.</td>
                                        <td>
                                            <asp:TextBox ID="txbInboundDoc" runat="server" 
                                                Text='<%# bind("InboundDocNo") %>' Width="250px"></asp:TextBox>
                                        </td>
                                        <td>
                                            &nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Container ID</td>
                                        <td>
                                            <asp:TextBox ID="txbContainerID" runat="server" 
                                                Text='<%# bind("InboundContainerID") %>' Width="250px"></asp:TextBox>
                                        </td>
                                        <td>
                                            &nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Brand Code</td>
                                        <td>
                                            <asp:DropDownList ID="ddBrandCodes" runat="server" 
                                                DataSourceID="sdsGetBrandCode" DataTextField="Product" 
                                                DataValueField="ID" SelectedValue='<%# bind("BrandCode") %>' Width="250px" AppendDataBoundItems="True">
                                                    <asp:ListItem Text="Select..." Value = "0" />
                                            </asp:DropDownList>
                                            <asp:SqlDataSource ID="sdsGetBrandCode" runat="server" 
                                                ConnectionString="<%$ ConnectionStrings:IMDB_SQL %>" 
                                    ...
                                    <tr>
                                        <td>
                                            Line No</td>
                                        <td>
                                            <asp:TextBox ID="txbLineNo" runat="server" 
                                                Text='<%# bind("ManifestLineNumber") %>' Width="250px"></asp:TextBox>
                                        </td>
                                        <td>
                                            &nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Profile</td>
                                        <td>
                                            <asp:DropDownList ID="ddProfile" runat="server" DataSourceID="sdsGetProfile" 
                                                DataTextField="Name" DataValueField="ID" 
                                                SelectedValue='<%# bind("InboundProfileID") %>' Width="250px" AppendDataBoundItems="True">
                                                    <asp:ListItem Text="Select..." Value = "" />
                                            </asp:DropDownList>
                                            <asp:SqlDataSource ID="sdsGetProfile" runat="server" 
                                                ConnectionString="<%$ ConnectionStrings:IMDB_SQL %>" 
                                    ...
                                    <tr>
                                        <td>
                                            Received As</td>
                                        <td>
                                            <asp:DropDownList ID="ddRecAs" runat="server" width="250px" 
                                    ...
                                    <tr>
                                        <td>
                                            Pallet Type</td>
                                        <td>
                                            <asp:DropDownList ID="ddPalletType" runat="server" 
                                                SelectedValue='<%# bind("InboundPalletType") %>' Width="250px">
                                    ...
                                    <tr>
                                        <td>
                                            Pallet Weight</td>
                                        <td>
                                            <asp:TextBox ID="txbPalletWeight" runat="server" 
                                                Text='<%# bind("InboundPalletWeight") %>' Width="250px"></asp:TextBox>
                                        </td>
                                        <td>
                                            &nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Container Type</td>
                                        <td>
                                            <asp:DropDownList ID="ddContainerTyper" runat="server" 
                                                SelectedValue='<%# bind("InboundContainerType") %>' Width="250px">
                                                <asp:ListItem Value="0">Select...</asp:ListItem>
                                    ...
                                    <tr>
                                        <td>
                                            Container Qty</td>
                                        <td>
                                                <asp:TextBox ID="txbContainerQty" runat="server" 
                                                    Text='<%# bind("InboundContainerQty") %>' Width="250px"></asp:TextBox>
                                        </td>
                                        <td>
                                            &nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Inventory Location</td>
                                        <td>
                                            <asp:DropDownList ID="ddLocation" runat="server" Width="250px" SelectedValue='<%# bind("InventoryLocation") %>' 
                                                DataSourceID="sdsGetLocation" DataTextField="LocationName" 
                                                DataValueField="LocationName"  AppendDataBoundItems="True">
                                                    <asp:ListItem Text="Select..." Value = "" />
                                            </asp:DropDownList>
                                            <asp:SqlDataSource ID="sdsGetLocation" runat="server" 
                                                ConnectionString="<%$ ConnectionStrings:IMDB_SQL %>" 
                                    ...
                                    <tr>
                                        <td>
                                            Process</td>
                                        <td>
                                            <asp:CheckBox ID="cbProcess" runat="server" width="250px" Checked='<%# bind("column1") %>' />
                                        </td>
                                        <td>
                                            &nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Process Plan As</td>
                                        <td>
                                            <asp:DropDownList ID="ddProcessPlan" runat="server" Width="250px" SelectedValue='<%# bind("ProcessPlan") %>'>
                                                <asp:ListItem>Select...</asp:ListItem>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" OnInserted="SqlDataSource2_Inserted" OnInserting="SqlDataSource2_Inserting" 
        ConnectionString="<%$ ConnectionStrings:IMDB_SQL %>" 
        DeleteCommand="DELETE FROM [RcvDetail] WHERE [ID] = @ID" 
        ...
        SelectCommand="SELECT [ID], [InboundDocNo], [ManifestLineNumber], [RcvHdrID], [InboundProfileID], [InboundContainerType], [InboundPalletType], [InboundPalletWeight], [InboundContainerQty], [InboundContainerID], [InventoryLocation], [BrandCode], [Process?] AS column1, [ProcessPlan], [RcvdAs], [ModDate], [UserName] FROM [RcvDetail] WHERE ([ID] = @ID)" 
        ...
        <SelectParameters>
            <asp:SessionParameter DefaultValue="0" Name="ID" 
                SessionField="CurDetailID" Type="Int32" />
        </SelectParameters>
        <UpdateParameters>
            <asp:Parameter Name="InboundDocNo" Type="String" />
            <asp:Parameter Name="ManifestLineNumber" Type="Int32" />
    ...
    <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
        ...
        <SelectParameters>
            <asp:SessionParameter DefaultValue="0" Name="ID" SessionField="CurDetailID" 
                Type="Int32" />
        </SelectParameters>
        <UpdateParameters>
            <asp:Parameter Name="InboundDocNo" Type="String" />
